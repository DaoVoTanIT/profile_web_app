...
class HomeProvider extends ChangeNotifier {
  ...
  Future<void> scrollToWorkExperience() async {
    final context = aboutKey.currentContext;
    await _scroll(context);
  }
  ...
  scrollBasedOnHeader(NameOnTap nameOnTap) {
    if (nameOnTap.title == "contact".tr()) {
      scrollToContact();
    } else if (nameOnTap.title == "home".tr()) {
      scrollToHome();
    } else if (nameOnTap.title == "project".tr()) {
      scrollToPortfolio();
    } else if (nameOnTap.title == "about".tr()) {
      scrollToAbout();
    } else if (nameOnTap.title == "workExperience".tr()) {
